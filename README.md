...
**The toolkit includes a library of functions for minimally intrusive code instrumentation (data logging/tracing), tools for decoding data on the host and demo code.
...
#### NewsFlash: RTEdbg toolkit released &nbsp; &nbsp; &nbsp; &Rightarrow; View news in the **[Newsroom](https://github.com/RTEdbg/RTEdbg/blob/master/Docs/NEWS.md)**
...
This repository is only for releasing the complete toolkit and documentation and does not contain any programming code.

The following repositories belong to the RTEdbg project:
* [**RTElibg** - Binary data logging/tracing library](https://github.com/RTEdbg/RTElib)
* [**RTEmsg** - Binary data decoding application](https://github.com/RTEdbg/RTEmsg)
